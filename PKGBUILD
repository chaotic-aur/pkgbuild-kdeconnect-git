...
depends=(kcmutils-git kwayland-git libfakekey qqc2-desktop-style-git qca-git kpeoplevcard-git pulseaudio-qt kirigami-git hicolor-icon-theme wayland-protocols-git plasma-wayland-protocols-git kpackage-git kwindowsystem-git kirigami2-git kirigami-addons-git kpeople-git)
